...
from app.app.insert_sample_data import insert_sample_data
from app.app.routes.unit import unit_bp
from app.app.routes.myschedule import myschedule_bp
...
def schedule_generation():
    ...
    return redirect(
        url_for("generate_schedule", unit_ids=",".join(map(str, selected_unit_ids)))
    )
